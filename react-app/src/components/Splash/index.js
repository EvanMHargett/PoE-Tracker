    ...
    return (
        <div className="splash">
            <div className='main'>
                ...
                <div className="about"> <span className="name"><p>Created By:</p><p>Evan Hargett</p></span> <a href="https://github.com/EvanMHargett"><img className="gh" src="/GitHub.png"></img></a><a href="https://www.linkedin.com/in/evan-hargett-47723b162/"><img className="li" src="/Linkedin.png"></img></a></div>
            </div>
